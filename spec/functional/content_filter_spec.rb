  ...
  module Test
    ...
    describe 'Generic Content filters' do
      ...
      it 'should return all fields by default' do
        ...
        expect(items[0].keys).to match_array [ :id, :colour, :shape, :translated_locale, :last_modified, :last_modified_by, :content_category, :is_published, :first_published, :page_owner]
      end

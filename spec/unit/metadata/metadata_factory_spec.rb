...
module Hacienda
  module Test
    ...
    describe MetadataFactory do
      ...
      it 'should create a new metadata with page owner' do
        metadata = MetadataFactory.new.create('some-id', 'ro', DateTime.new(2014, 1, 1).to_s, 'some author', page_owner: 'owner')

...
module Hacienda
  ...
  class HaciendaService < Sinatra::Base
    ...
    post create_item_regexp, auth: true do
      create_response = create_content_controller.create(params[:type], params[:data], params[:locale], request.env['HTTP_LAST_MODIFIED_BY'], category: request.env['HTTP_PAGE_CATEGORY'])
